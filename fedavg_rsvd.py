...
def fedavg_rsvd(
    ...
    rayleaf.run_experiment(
        ...
        output_dir= Path(output_dir, dataset, "fedavg", f"r{str(rank).zfill(4)}-{num_clients}clients-{clients_per_round}cpr-{client_lr}lr-{num_epochs}epochs-{num_rounds}rounds"),
        model = model,
